...
<div id="auth" style="background:url(https://compassionate-lamarr.185-137-122-9.plesk.page/ok/public/assets/images/bg/background.png); background-size: cover;">
    <div class="row h-100" style="margin: 100px;">
    ...
    margin-top: 130px}">
            <div id="auth-left">
                ...
                <div class="text-center mt-5 text-lg fs-4">
                    <p class=""style="color:#fff;font-size:15px;">Don't have an account? <a href="auth-register.html" class="font-bold"style="color:#C20000;">Sign
                            up</a>.</p>
